## this one failed, has massive errors. was probably due to me changing the token name from TonyBatch107 to tonyBatch107 between minting
## token creation worked fine but the script was not saves on nami, the coins cound be sent to another address but could not be burnt
...
saveOR :: IO ()
saveOR  = writeDataToFile "./testnet/ourRedeemer.json" (OR Owner "a2a15a1901d0229101bcb31629629210ce8d2ccf058d05afea33e273" 1686837045000 50)
...
## burn.sh second script 
## added second output for coins not burnt
