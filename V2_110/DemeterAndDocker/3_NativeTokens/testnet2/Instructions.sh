...
## make sure you burn all the tokens in the wallet or transfer the tokens you want to burn to a wallet first or
## make a new output for the balance of the tokens with some ADA.
