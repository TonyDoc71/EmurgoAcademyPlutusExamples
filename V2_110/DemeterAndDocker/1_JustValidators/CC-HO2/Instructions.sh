## will do a more complex one have the signer from a different wallet than the owner
## will use multimple UTXOs in
## will send some value back to the conditionator.addr to redeem later


## signer 1en107.addr / 1ent107.pkh
## owner 4stake2.addr / 4payment2.pkh
## collateral 5stake3.addr / 5payment3.pkh
