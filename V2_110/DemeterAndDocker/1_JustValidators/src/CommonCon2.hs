...
saveConditionsValidator =  writeValidatorToFile "./CC-HO3/conditionator.plutus" conditionsValidator

saveUnit :: IO ()
saveUnit = writeDataToFile "./CC-HO3/unit.json" ()

saveDatum :: IO ()
saveDatum  = writeDataToFile "./CC-HO3/datum.json" (Conditions "832bb3d5216092580bb596b6fd35ae845c63adececd7958466ec38a5" 1713266844000 100)

saveRedeemerOwner :: IO ()
saveRedeemerOwner = writeDataToFile "./CC-HO3/redeemOwner.json" Owner

saveRedeemerTime :: IO ()
saveRedeemerTime = writeDataToFile "./CC-HO3/redeemTime.json" Time

saveRedeemerPrice :: IO ()
saveRedeemerPrice = writeDataToFile "./CC-HO3/redeemPrice.json" Price
